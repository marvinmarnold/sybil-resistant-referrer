...
export default function ENSExample() {
 return (
  <div>
   ...
   <p>
    This example demonstrates how to use the Ethereum Name Service (ENS) to resolve human-readable names to Ethereum addresses. ENS is a decentralized
    domain name system that allows users to register and map domain names to Ethereum addresses.
   </p>
   <FetchENS />
  </div>
 )
