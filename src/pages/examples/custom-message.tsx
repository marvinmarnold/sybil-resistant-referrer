...
export default function MessageExample() {
 ...
 return (
  <div>
   ...
   <Text>
    This example shows a custom Solidity smart contract deployed using Hardhat. You can find sample contract under <Code>/contracts</Code>. Contracts
    are automatically verified on Etherscan and types and hooks are generated using <Code>wagmi-cli</Code>
   </Text>
